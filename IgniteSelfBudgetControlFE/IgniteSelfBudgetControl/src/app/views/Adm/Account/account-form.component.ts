...
export class AccountFormComponent implements OnInit {
 ...
 public load1(args: ILoadedEventArgs ): void {
  ...
  getRepayment() {
    this.accountControllerService.configuration.basePath= extraConfig.basePath;
...
this.spendingControllerService.configuration.basePath= extraConfig.basePath;
  ...
  getDepositesByAccount() {
    this.depositeControllerService.configuration.basePath= extraConfig.basePath;
  ...
  newSpending() {
    const navigationExtras: NavigationExtras = {
      state: {
        accountId: this.object.id
      }
    };
    this.route.navigateByUrl("/Adm/SpendingForm", navigationExtras);
  }
  position = 'top-center';
  visible = false;
  percentage = 0;
